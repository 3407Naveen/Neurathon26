            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3rem' }}>
                <div style={{ padding: '2rem', background: 'rgba(255,255,255,0.05)', borderRadius: '12px', border: '1px solid var(--gold-dim)' }}>
                    ...
                    <p style={{ lineHeight: '1.8', fontSize: '1.1rem' }}>
                        NEURATHON is a premier 30-hour national-level hackathon designed to ignite the spark of innovation in young minds.
                ...
                <div style={{ padding: '2rem', background: 'rgba(255,255,255,0.05)', borderRadius: '12px', border: '1px solid var(--gold-dim)' }}>
                    ...
                    <p style={{ lineHeight: '1.8', fontSize: '1.1rem' }}>
                        Organized by the Department of Artificial Intelligence and Data Science at <strong style={{ color: 'var(--text-primary)' }}>New Prince Shri Bhavani College of Engineering and Technology</strong>, Chennai.
